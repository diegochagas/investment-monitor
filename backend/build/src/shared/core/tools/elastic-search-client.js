...
var ElasticSearchClient = /** @class */ (function () {
    function ElasticSearchClient() {
    }
    /**
     * Get elastic search client.
     */
    ElasticSearchClient.getInstance = function () {
            ...
            return __generator(this, function (_a) {
                if (!ElasticSearchClient.client) {
                    ElasticSearchClient.client = new ElasticSearch.Client({
                        ...
                        requestTimeout: parseInt(process.env.ELASTICSEARCH_TIMEOUT),
                        connectionClass: HttpAwsEs
                    });
                }
                return [2 /*return*/, ElasticSearchClient.client];
            });
        });
    };
...
//# sourceMappingURL=elastic-search-client.js.map