...
exports.getHeaders = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var serviceResponse, e_1, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, factorPool_1.services.get(projectName_1.HeaderProject[req.header(factorPool_1.HEADER_PROJECT_NAME)]).getHeaders()];
            case 1:
            ...
            case 2:
                e_1 = _a.sent();
                winston_1.default.error("STRATEGY_GET_HEADERS (" + e_1.message + ") =>", e_1);
