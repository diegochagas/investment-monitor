...
var routes_route_1 = __importDefault(require("../routes/routes.route"));
...
exports.configRoute = function (app) {
    var appRoute = express_1.default();
    appRoute.use('/', routes_route_1.default);
    app.use('/route', appRoute);
    appRoute.use(addRequestId);
    appRoute.use(body_parser_1.default.json());
    appRoute.use(cors_1.default());
};
