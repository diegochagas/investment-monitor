...
exports.save = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_user_1.ServiceUser.save(req.body)];
            case 1:
                response = _a.sent();
...
exports.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_user_1.ServiceUser.getAll()];
            case 1:
                response = _a.sent();
                res.status(response.statusCode).json(response);
                return [3 /*break*/, 3];
...
exports.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, service_user_1.ServiceUser.getById(req.params.id)];
            case 1:
                response = _a.sent();
                res.status(response.statusCode).json(response);
                return [3 /*break*/, 3];
