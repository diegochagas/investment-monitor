        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        message.acks = 0;
                        winston_1.default.info(prefix + "Send message to Producer: ", message);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.producer.send(message)];
                    case 3:
                        _a.sent();
                    ...
                    case 5:
                        e_1 = _a.sent();
                        winston_1.default.error(prefix + ("error send to message: " + e_1.message));
                        return [3 /*break*/, 6];
