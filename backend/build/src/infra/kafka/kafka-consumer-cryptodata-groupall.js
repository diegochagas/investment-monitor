...
var prefix = "KAFKA_CONSUMER_CRYPTODATA_GROUPALL => ";
var KafkaConsumerCryptodataGroupall = /** @class */ (function () {
    function KafkaConsumerCryptodataGroupall() {
        this.topics = [];
        this.contents = {};
        this.client = kafka_client_1.KafkaClient.getInstance().getClient();
        this.createConsumer();
    }
    KafkaConsumerCryptodataGroupall.prototype.createConsumer = function () {
        this.consumer = this.client.consumer({
            groupId: "group_cryptodata_groupall",
            allowAutoTopicCreation: true,
        });
    };
    KafkaConsumerCryptodataGroupall.getInstance = function () {
    ...
    KafkaConsumerCryptodataGroupall.prototype.init = function () {
    ...
    KafkaConsumerCryptodataGroupall.prototype.getTopics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, Topic_1.TopicSchema.find({ group: 'ALL' })];
                    case 1:
                        _a.topics = _b.sent();
                        return [2 /*return*/];
                }
    ...
    KafkaConsumerCryptodataGroupall.prototype.getConsumers = function () {
        return this.topics.map(function (topic) { return ({
            topic: ("" + topic.name + (topic.type ? "_" + topic.type : '')).toUpperCase(),
        }); });
    };
    KafkaConsumerCryptodataGroupall.prototype.connectConsumers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_1, _a, consumers, _b, _c, topic, e_1_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        winston_1.default.info(prefix + "connect to consumers");
                        consumers = this.getConsumers();
                        if (!(consumers.length > 0)) return [3 /*break*/, 11];
                    ...
                    case 10:
                        ...
                        return [2 /*return*/];
                    case 11:
                        winston_1.default.warn(prefix + "0 topics to connect");
                        _d.label = 12;
    ...
    KafkaConsumerCryptodataGroupall.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                            ...
                            eachMessage: function (_a) {
                                ...
                                return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        ...
                                        winston_1.default.debug(prefix + "sending to socket", this.contents);
                                        ws_service_1.WSServer.getInstance().send(this.contents, "COIN_API_ALL");
    ...
    KafkaConsumerCryptodataGroupall.prototype.addTopics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var aux, e_2, e_3, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Topic_1.TopicSchema.find({ group: 'ALL' })];
                    case 1:
                        aux = _a.sent();
    ...
    return KafkaConsumerCryptodataGroupall;
}());
exports.KafkaConsumerCryptodataGroupall = KafkaConsumerCryptodataGroupall;
//# sourceMappingURL=kafka-consumer-cryptodata-groupall.js.map